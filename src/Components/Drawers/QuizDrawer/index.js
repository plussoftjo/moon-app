...
@inject('auth')
@observer
export default class QuizDrawer extends React.Component {
    constructor(props) {
        super(props);

        this.state = {sections:[
            {title:'Home',title_ar:'الرئيسية',icon:'home',at:'AppMainScreen'},
            {title:'My Task',title_ar:'اختباراتي',icon:'monitor',at:'MyQuizes'},
            {title:'Task Result',title_ar:'نتائج الاختبار',icon:'monitor',at:'QuizAwnser'},
            {title:'About Us',title_ar:'حول التطبيق',icon:'file-text',at:'AboutUs'},
            {title:'Contact Us',title_ar:'اتصل بنا',icon:'message-circle',at:'ContactUs'},
