...
export default class MainDrawer extends React.Component {
    constructor(props) {
        ...
        this.state = {sections:[
            ...
            {title:'Shop',title_ar:'المتجر',icon:'shopping-bag',at:'Shop'},
            {title:'Psychological counseling',title_ar:'استشارات نفسية',icon:'users',at:'SectionA'},
            {title:'Courses',title_ar:'الدورات',icon:'monitor',at:'Courses'},
            {title:'Psychological tests',title_ar:'اختبارات نفسية',icon:'edit',at:'Quiz'},
            {title:'Sport',title_ar:'الرياضة',icon:'award',at:'Sport'},
